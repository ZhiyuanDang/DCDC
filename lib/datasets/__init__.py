...
from .cifar import CIFAR10, CIFAR100, tinyimagenet
...
cfg.register_class(_MODULE_, 'tinyimagenet', tinyimagenet)
cfg.register_class(_MODULE_, 'imagenet10', tinyimagenet)
cfg.register_class(_MODULE_, 'imagenetdog', tinyimagenet)
